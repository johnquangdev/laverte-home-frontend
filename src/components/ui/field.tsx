...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        "text-gray text-sm leading-normal font-normal group-has-data-[orientation=horizontal]/field:text-balance",
...
function FieldSeparator({
  ...
  return (
    ...
    >
      ...
      {children && (
        <span
          className="bg-background-1 text-gray relative mx-auto block w-fit px-2"
